 ...
 *
 * Get Count [Song]s NotStarted UseCase
 *
 */

class CountSongsNotStartedUseCase(private val songRepository: SongRepository) {
    operator fun invoke() = songRepository.countStatusNotStarted()
}